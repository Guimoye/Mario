        ...
        bundle       = new Bundle();
         ...
         if (id == R.id.nav_perfil) {
            ...
            fm.beginTransaction().replace(R.id.content_frame, fragobj).commit();
             ...
             bundle.putString("correo",correo);
             Fragment fragobj = new frag_ubicacion();
             fragobj.setArguments(bundle);
             fm.beginTransaction().replace(R.id.content_frame, fragobj).commit();
         ...
         }else if (id == R.id.nav_permiso) {

             navigationView.setCheckedItem(R.id.nav_permiso);
             Fragment fragobj = new frag_permiso();
             fragobj.setArguments(bundle);
             fm.beginTransaction().replace(R.id.content_frame, fragobj).commit();

         } else if  (id == R.id.nav_msj) {

             fm.beginTransaction().replace(R.id.content_frame, new frag_mensajes()).commit();
